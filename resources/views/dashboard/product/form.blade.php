    ...
    <div class="card alert">
        <div class="card-header">
            ...
            <div class="clearfix header-buttons text-right m-t-20">
                <a href="{{route('product.index')}}" class="btn btn-default btn-sm btn-outline"><i class="ti-close"></i> Cancel</a>
                <a href="#" class="btn btn-primary btn-sm {{isset($d)?'update':'save'}}-form" data-callback="{{ route('product.index') }}" data-status="1"  data-target="#main-form"><i class="ti-save"></i> Save</a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="card alert">
                    <div class="card-body">
                        <form id='main-form' data-url="{{ isset($d)?route('product.update', ['product' => $d->id]):route('product.store') }}">
                            @if(isset($d))    
                                @method('PUT')
                            @endif
                                            ...
                                            <div class="card-body">
                                                <div class="basic-form">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" class="form-control" value="{{ isset($d)?$d->name:''}}" placeholder="Product Name" required>
                                                    </div>
                                                    
                                                    <div class="form-group">
                                                        <label>Type (Product or Service)</label>
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <div class="card alert">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label>Content</label>
                                                    <textarea name="content" data-height="300" class="form-control editor" style="min-height: 200px" placeholder="Content">{!! isset($d)?$d->content:'' !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
