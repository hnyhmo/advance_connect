    ...
    <div class="card alert">
        <div class="card-header">
            ...
            <div class="clearfix header-buttons text-right m-t-20">
                <a href="{{route('team.index')}}" class="btn btn-default btn-sm btn-outline"><i class="ti-close"></i> Cancel</a>
                <a href="#" class="btn btn-primary btn-sm {{isset($d)?'update':'save'}}-form" data-callback="{{ route('team.index') }}" data-status="1"  data-target="#main-form"><i class="ti-save"></i> Save</a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="card alert">
                    <div class="card-body">
                        <form id='main-form' data-url="{{ isset($d)?route('team.update', ['team' => $d->id]):route('team.store') }}">
                            @if(isset($d))    
                                @method('PUT')
                            @endif
